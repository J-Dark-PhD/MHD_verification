...
for Ha_value in Ha_test_values:
    for mesh_value in mesh_test_values:
        ...
        # conductive_results_folder = "Results/mesh_testing/conductive/Ha={}/mesh={}x{}/".format(Ha_value, mesh_value, mesh_value)
        # mhd_sim(
        #     Ha_no=Ha_value,
        #     conductive=True,
        ...
        print("Mesh size = {} x {}".format(mesh_value, mesh_value))
        insulated_results_folder = "Results/mesh_testing/insulated/Ha={}/mesh={}x{}/".format(Ha_value, mesh_value, mesh_value)
        mhd_sim(
            Ha_no=Ha_value,
            conductive=False,
